...
- Still blocked/manual after redeploy: Supabase/Postgres persistence, login/test account workflow, email delivery, public links, Stripe/Square sandbox webhooks, Google OAuth/Calendar, Mapbox deployed workflow, and full deployed end-to-end workflow.
