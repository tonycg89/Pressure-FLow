...
- Still blocked/manual after redeploy: restart/redeploy persistence proof, Stripe/Square sandbox webhooks, Mapbox deployed workflow, and final external-beta go/no-go review.
