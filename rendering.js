...
function estimatePageStyles() {
  return `<style>
    *, *::before, *::after { box-sizing: border-box; }
    body { margin: 0; min-width: 320px; min-height: 100vh; overflow-wrap: anywhere; background: #f7f8fb; color: #202124; font-family: Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
    main,
    .doc { width: min(760px, calc(100vw - 32px)); max-width: 100%; margin: 32px auto; padding: 24px; border: 1px solid #d8dee8; border-radius: 12px; background: white; box-shadow: 0 12px 28px rgba(16, 24, 40, 0.08); }
    ...
    .table th,
    .table td { min-width: 0; padding: 12px; overflow-wrap: anywhere; border-bottom: 1px solid #d8dee8; text-align: left; vertical-align: top; }
    ...
    th, td { min-width: 0; padding: 12px 8px; overflow-wrap: anywhere; border-bottom: 1px solid #d8dee8; text-align: left; }
