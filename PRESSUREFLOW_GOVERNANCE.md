...
- Phase 07D deployment sandbox verification has started and is currently no-go for external beta because the deployed `/health` payload indicates the hosted app is not running the latest readiness code.
