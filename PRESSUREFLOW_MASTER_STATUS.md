...
- Items still blocked/manual: restart/redeploy persistence proof, Stripe/Square sandbox webhooks, Mapbox deployed workflow, and final external-beta go/no-go review.
