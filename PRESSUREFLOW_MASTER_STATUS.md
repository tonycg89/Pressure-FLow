...
- Items still blocked/manual: Stripe/Square sandbox credential setup and provider webhook acceptance, restart/redeploy persistence proof, and final external-beta go/no-go review.
